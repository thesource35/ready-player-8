...
// 2026-05-06: rental data lives in lib/links/externalLinks.ts as the canonical
// source. Previously this file had its own copy that drifted (Sunbelt URLs
// went stale, BlueLine acquisition wasn't reflected). Importing keeps both
// link-health and the live page in sync going forward.
import { rentalProviders as providers, rentalItems as items } from "@/lib/links/externalLinks";
