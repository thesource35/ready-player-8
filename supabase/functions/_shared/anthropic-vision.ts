// Phase 29 LIVE-08 — Deno-side mirror of web/src/lib/live-feed/anthropic-vision.ts.
// KEEP THIS FILE IN LOCK-STEP with the Next.js copy. Any change to the prompt or schema
