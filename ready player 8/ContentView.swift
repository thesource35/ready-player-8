...
struct PDFExporter {
    static func generateReport(title: String, sections: [(heading: String, content: String)]) -> Data? {
        ...
        return renderer.pdfData { context in
            ...
            titleStr.draw(in: CGRect(x: margin, y: yPos, width: contentWidth, height: 40))
            yPos += 50
            ...
            dateStr.draw(in: CGRect(x: margin, y: yPos, width: contentWidth, height: 20))
            yPos += 30
            ...
            for section in sections {
                ...
                NSAttributedString(string: section.heading, attributes: headingAttrs)
                ...
                let bodyRect = CGRect(x: margin, y: yPos, width: contentWidth, height: pageHeight - yPos - margin)
                bodyStr.draw(in: bodyRect)
                let boundingRect = bodyStr.boundingRect(with: CGSize(width: contentWidth, height: .greatestFiniteMagnitude), options: [.usesLineFragmentOrigin], context: nil)
            ...
            NSAttributedString(string: "Generated by ConstructionOS", attributes: footerAttrs)
...
// API key is stored in @AppStorage("ConstructOS.AngelicAI.APIKey").
