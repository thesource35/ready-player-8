...
- [ ] 25-02-PLAN.md — Fanout enhancements: cert-specific push copy, APNs category registration (Wave 1)
- [ ] 25-03-PLAN.md — iOS urgency badges, summary banner, renewal CTA, pulse animation, XCTest (Wave 2)
- [ ] 25-04-PLAN.md — Web urgency badges, summary banner, deep-link highlight, renewal CTA, vitest (Wave 2)
...
| 25. Certification Expiry Notifications | v2.1 | 1/7 | In Progress|  |
