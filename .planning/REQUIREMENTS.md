...
|-------------|-------|--------|
| NOTIF-01 | Phase 30 (30-02 iOS Menu picker + InboxView; 30-04..06 web InboxProjectPicker + page.tsx; bell badge "99+" cap on both) | Satisfied |
...
- Mapped to phases: 61
- Unmapped: 0
- **`[x]` Satisfied: 38** — NOTIF-01, NOTIF-02, NOTIF-03, NOTIF-04, DOC-02, DOC-03, TEAM-01..05, CAL-03, FIELD-02, FIELD-03 (14 carryover) + VIDEO-01-A..P (16 Phase 22) + LIVE-01, LIVE-05, LIVE-08, LIVE-14 (4 Phase 29 code-verified) + AUTH-GATE-01, AUTH-GATE-02, AUTH-GATE-03 (3 Phase 29.1 — code green + 3-scenario iOS Simulator UAT PASSED 2026-04-21) + AUTH-GATE-04 (1 Phase 30.1 — code green + UAT Steps 1-4 PASS 2026-04-27 on iPhone 17 Simulator iOS 26.3)
...
- **`[ ]` Unsatisfied / Planned: 1** — NOTIF-05 (APNs push delivery on real device; Apple Developer portal Push Notifications capability toggle never recorded — UAT-blocked, not code-blocked. NOTIF-01 + NOTIF-03 reconciled 2026-04-26 to Satisfied; AUTH-GATE-04 reconciled 2026-04-27 to Satisfied — all shipped under Phase 30 plans 30-01..30-06 + Phase 30.1 with bookkeeping updated this session.)
